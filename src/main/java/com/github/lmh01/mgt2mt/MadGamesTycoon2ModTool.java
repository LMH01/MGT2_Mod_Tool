...
public class MadGamesTycoon2ModTool {
    ...
    public static final String VERSION = "1.8.3a";//When changing version check that the version is included in the version compatible strings in SharingManager
