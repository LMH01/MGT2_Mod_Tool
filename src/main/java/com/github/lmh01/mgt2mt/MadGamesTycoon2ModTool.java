...
public class MadGamesTycoon2ModTool {
    ...
    public static final String VERSION = "2.0.6-dev";//Version numbers that include "dev" are not checked for updates / tool will notify if update is available
    public static final String CURRENT_RELEASE_VERSION = "2.0.5";//When this version number has been detected as the newest release version the update available message is held back
