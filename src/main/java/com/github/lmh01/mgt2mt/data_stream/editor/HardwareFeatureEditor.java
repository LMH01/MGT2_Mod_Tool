...
public class HardwareFeatureEditor extends AbstractAdvancedEditor {
    private static final Logger LOGGER = LoggerFactory.getLogger(HardwareFeatureEditor.class);
    @Override
