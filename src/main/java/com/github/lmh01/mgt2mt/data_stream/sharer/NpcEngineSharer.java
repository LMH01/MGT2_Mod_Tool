...
public class NpcEngineSharer extends AbstractAdvancedSharer {
    ...
    public void printValues(Map<String, String> map, BufferedWriter bw) throws IOException {
        ...
        bw.write("[GENRE]" + ModManager.genreModOld.getAnalyzer().getContentNameById(Integer.parseInt(map.get("GENRE"))));bw.write(System.getProperty("line.separator"));
        bw.write("[PLATFORM]" + ModManager.platformModOld.getBaseAnalyzer().getContentNameById(Integer.parseInt(map.get("PLATFORM"))));bw.write(System.getProperty("line.separator"));
    ...
    public Importer getImporter() {
        return ModManager.npcEngineModOld.getBaseEditor()::addMod;
    }
    ...
    public AbstractAdvancedModOld getAdvancedMod() {
        return ModManager.npcEngineModOld;
    }
