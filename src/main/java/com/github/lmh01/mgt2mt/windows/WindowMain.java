...
public class WindowMain {
    ...
    public static void createFrame(){
        ...
        m221AddGenre.addActionListener(actionEvent -> ThreadHandler.startThread("runnableAddNewGenre"));
        m222AddRandomGenre.setToolTipText(I18n.INSTANCE.get("window.main.mods.genres.addRandomGenre.toolTip"));
        m222AddRandomGenre.addActionListener(actionEvent -> ThreadHandler.startThread("runnableAddRandomizedGenre"));
        ...
        m251AddEngineFeature.addActionListener(actionEvent -> ThreadHandler.startThread("runnableAddNewEngineFeature"));
        M_252_REMOVE_ENGINE_FEATURE.addActionListener(actionEvent -> ThreadHandler.startThread("runnableRemoveEngineFeature"));
        m271AddLicence.addActionListener(actionEvent -> ThreadHandler.startThread("runnableAddNewLicence"));
