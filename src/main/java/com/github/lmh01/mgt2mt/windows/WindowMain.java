...
public class WindowMain {
    ...
    public static void createFrame() {
        ...
        JMenuItem m53OpenFeatureList = new JMenuItem(I18n.INSTANCE.get("window.main.utilities.openFeatureList"));
        m53OpenFeatureList.addActionListener(actionEvent -> ThreadHandler.startModThread(Utils::openFeatureList, "openFeatureList"));
        JMenuItem m54OpenMGT2Folder = new JMenuItem(I18n.INSTANCE.get("window.main.utilities.openMGT2Folder"));
        m54OpenMGT2Folder.addActionListener(actionEvent -> Utils.open(Settings.mgt2Path));
        ...
        m55OpenSaveGameFolder.addActionListener(actionEvent -> Utils.open(Backup.FILE_SAVE_GAME_FOLDER));
        JMenuItem m56OpenSettingsTomlFile = new JMenuItem(I18n.INSTANCE.get("window.main.utilities.openSettingsTomlFile"));
        m56OpenSettingsTomlFile.setToolTipText(I18n.INSTANCE.get("window.main.utilities.openSettingsTomlFile.toolTip"));
        m56OpenSettingsTomlFile.addActionListener(actionEvent -> Utils.open(ModManagerPaths.MAIN.getPath().resolve("settings.toml")));
        JMenuItem m570ReanalyzeGameFiles = new JMenuItem(I18n.INSTANCE.get("window.main.utilities.reanalyzeGameFiles"));
        m570ReanalyzeGameFiles.setToolTipText(I18n.INSTANCE.get("window.main.utilities.reanalyzeGameFiles.toolTip"));
        m570ReanalyzeGameFiles.addActionListener(actionEvent -> reanalyzeGameFiles());
        JMenuItem m580GenerateHelpSheet = new JMenuItem(I18n.INSTANCE.get("window.main.utilities.generateHelpSheet"));
        m580GenerateHelpSheet.setToolTipText(I18n.INSTANCE.get("window.main.utilities.generateHelpSheet.toolTip"));
        m580GenerateHelpSheet.addActionListener(actionEvent -> ThreadHandler.startModThread(HelpSheetGenerator::generate, "HelpSheetGenerator"));
        MB.add(M_5_UTIL);
        M_5_UTIL.add(m52OpenGitHubPage);
        M_5_UTIL.add(m53OpenFeatureList);
        M_5_UTIL.add(m54OpenMGT2Folder);
        M_5_UTIL.add(m55OpenSaveGameFolder);
        M_5_UTIL.add(m56OpenSettingsTomlFile);
        M_5_UTIL.add(m570ReanalyzeGameFiles);
        M_5_UTIL.add(m580GenerateHelpSheet);
