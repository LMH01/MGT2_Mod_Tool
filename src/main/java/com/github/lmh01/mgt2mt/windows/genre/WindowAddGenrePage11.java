        ...
        buttonNext.addActionListener(actionEvent -> {
            if(textFieldImagePath.getText().isEmpty()){
                if(JOptionPane.showConfirmDialog(null, "You did not enter a custom image.\nDo you want to reset the image file to default?", "Reset image?", JOptionPane.YES_NO_OPTION) == JOptionPane.OK_OPTION){
                    ...
                    GenreManager.addGenre(GenreManager.mapNewGenre, WindowAddGenrePage1.getMapGenreTranslations(), WindowAddGenrePage6.compatibleThemeIds, WindowAddGenrePage7.gameplayFeaturesGoodIds, WindowAddGenrePage7.gameplayFeaturesBadIds, WindowAddGenrePage10.arrayListScreenshotFiles, false, genreIcon);
                    FRAME.dispose();
                }
            }else{
