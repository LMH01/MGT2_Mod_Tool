...
public class DevLegendsManager extends AbstractSimpleContentManager {
    ...
    public static final String[] compatibleModToolVersions = new String[]{"4.3.0", "4.3.1", "4.4.0", "4.5.0", "4.6.0", "4.7.0", "4.8.0", "4.9.0-alpha1", "4.9.0-beta1", MadGamesTycoon2ModTool.VERSION};
