...
public class LicenceManager extends AbstractSimpleContentManager implements DependentContentManager {
    ...
    public static final String[] compatibleModToolVersions = new String[]{"4.2.0", "4.2.1", "4.2.2", "4.3.0", "4.3.1", "4.4.0", "4.5.0", "4.6.0", "4.7.0", "4.8.0", "4.9.0-alpha1", "4.9.0-beta1", MadGamesTycoon2ModTool.VERSION};
