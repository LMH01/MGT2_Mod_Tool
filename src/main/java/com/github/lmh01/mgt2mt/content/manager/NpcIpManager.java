...
import com.github.lmh01.mgt2mt.content.NpcIp;
...
public class NpcIpManager extends AbstractSimpleContentManager implements DependentContentManager {
    ...
    public static final String[] compatibleModToolVersions = new String[]{"4.0.0", "4.1.0", "4.2.0", "4.2.1", "4.2.2", "4.3.0", MadGamesTycoon2ModTool.VERSION};
