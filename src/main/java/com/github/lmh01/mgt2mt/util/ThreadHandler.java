...
public class ThreadHandler {
    ...
    public static Runnable runnableExportEngineFeatures = () -> OperationHelper.process((string) -> SharingManager.engineFeatureSharer.exportMod(string, false), AnalyzeManager.engineFeatureAnalyzer.getCustomContentString(), AnalyzeManager.engineFeatureAnalyzer.getContentByAlphabet(), I18n.INSTANCE.get("commonText.engineFeature"), I18n.INSTANCE.get("commonText.exported"), I18n.INSTANCE.get("commonText.export"), I18n.INSTANCE.get("commonText.exporting"), true);
    public static Runnable runnableExportGameplayFeatures = () -> OperationHelper.process((string) -> SharingManager.gameplayFeatureSharer.exportMod(string, false), AnalyzeManager.gameplayFeatureAnalyzer.getCustomContentString(), AnalyzeManager.gameplayFeatureAnalyzer.getContentByAlphabet(), I18n.INSTANCE.get("commonText.gameplayFeature"), I18n.INSTANCE.get("commonText.exported"), I18n.INSTANCE.get("commonText.export"), I18n.INSTANCE.get("commonText.exporting"), true);
    public static Runnable runnableExportThemes = () -> OperationHelper.process((string) -> SharingManager.themeSharer.exportMod(string, false), AnalyzeManager.themeFileEnAnalyzer.getCustomContentString(), AnalyzeManager.themeFileEnAnalyzer.getContentByAlphabet(), I18n.INSTANCE.get("commonText.theme"), I18n.INSTANCE.get("commonText.exported"), I18n.INSTANCE.get("commonText.export"), I18n.INSTANCE.get("commonText.exporting"), true);
    public static Runnable runnableExportPublisher = () -> OperationHelper.process((string) -> SharingManager.publisherSharer.exportMod(string, false), AnalyzeManager.publisherAnalyzer.getCustomContentString(), AnalyzeManager.publisherAnalyzer.getContentByAlphabet(), I18n.INSTANCE.get("commonText.publisher"), I18n.INSTANCE.get("commonText.exported"), I18n.INSTANCE.get("commonText.export"), I18n.INSTANCE.get("commonText.exporting"), true);
    public static Runnable runnableExportGenre = () -> OperationHelper.process((string) -> SharingManager.genreSharer.exportMod(string, false), AnalyzeManager.genreAnalyzer.getCustomContentString(), AnalyzeManager.genreAnalyzer.getContentByAlphabet(), I18n.INSTANCE.get("commonText.genre"), I18n.INSTANCE.get("commonText.exported"), I18n.INSTANCE.get("commonText.export"), I18n.INSTANCE.get("commonText.exporting"), true);
