...
public class ThreadHandler {
    ...
    public static Runnable runnableExportLicence = () -> OperationHelper.process((string) -> SharingManagerNew.licenceSharer.exportMod(string, false), AnalyzeManager.licenceAnalyzer.getCustomContentString(), AnalyzeManager.licenceAnalyzer.getContentByAlphabet(), I18n.INSTANCE.get("commonText.licence"), I18n.INSTANCE.get("commonText.exported"), I18n.INSTANCE.get("commonText.export"), I18n.INSTANCE.get("commonText.exporting"), true);
    public static Runnable runnableExportEngineFeatures = () -> OperationHelper.process((string) -> SharingManagerNew.engineFeatureSharer.exportMod(string, false), AnalyzeManager.engineFeatureAnalyzer.getCustomContentString(), AnalyzeManager.engineFeatureAnalyzer.getContentByAlphabet(), I18n.INSTANCE.get("commonText.engineFeature"), I18n.INSTANCE.get("commonText.exported"), I18n.INSTANCE.get("commonText.export"), I18n.INSTANCE.get("commonText.exporting"), true);
    public static Runnable runnableExportGameplayFeatures = () -> OperationHelper.process((string) -> SharingManagerNew.gameplayFeatureSharer.exportMod(string, false), AnalyzeManager.gameplayFeatureAnalyzer.getCustomContentString(), AnalyzeManager.gameplayFeatureAnalyzer.getContentByAlphabet(), I18n.INSTANCE.get("commonText.gameplayFeature"), I18n.INSTANCE.get("commonText.exported"), I18n.INSTANCE.get("commonText.export"), I18n.INSTANCE.get("commonText.exporting"), true);
    public static Runnable runnableExportThemes = () -> OperationHelper.process((string) -> SharingHandler.exportTheme(string, false), AnalyzeManager.themeFileEnAnalyzer.getCustomContentString(), AnalyzeManager.themeFileEnAnalyzer.getContentByAlphabet(), I18n.INSTANCE.get("commonText.theme"), I18n.INSTANCE.get("commonText.exported"), I18n.INSTANCE.get("commonText.export"), I18n.INSTANCE.get("commonText.exporting"), true);
    public static Runnable runnableExportPublisher = () -> OperationHelper.process((string) -> SharingManagerNew.publisherSharer.exportMod(string, false), AnalyzeManager.publisherAnalyzer.getCustomContentString(), AnalyzeManager.publisherAnalyzer.getContentByAlphabet(), I18n.INSTANCE.get("commonText.publisher"), I18n.INSTANCE.get("commonText.exported"), I18n.INSTANCE.get("commonText.export"), I18n.INSTANCE.get("commonText.exporting"), true);
    public static Runnable runnableExportGenre = () -> OperationHelper.process((string) -> SharingManagerNew.genreSharer.exportMod(string, false), AnalyzeManager.genreAnalyzer.getCustomContentString(), AnalyzeManager.genreAnalyzer.getContentByAlphabet(), I18n.INSTANCE.get("commonText.genre"), I18n.INSTANCE.get("commonText.exported"), I18n.INSTANCE.get("commonText.export"), I18n.INSTANCE.get("commonText.exporting"), true);
    ...
    public static Runnable runnableRemoveGenre = () -> OperationHelper.process(EditorManager.genreEditor::removeMod, AnalyzeManager.genreAnalyzer.getCustomContentString(), AnalyzeManager.genreAnalyzer.getContentByAlphabet(), I18n.INSTANCE.get("commonText.genre"), I18n.INSTANCE.get("commonText.removed"), I18n.INSTANCE.get("commonText.remove"), I18n.INSTANCE.get("commonText.removing"), false);
    public static Runnable runnableRemoveTheme = () -> OperationHelper.process(EditorManager.themeEditor::removeMod, AnalyzeManager.themeFileEnAnalyzer.getCustomContentString(), AnalyzeManager.themeFileEnAnalyzer.getContentByAlphabet(), I18n.INSTANCE.get("commonText.theme"), I18n.INSTANCE.get("commonText.removed"), I18n.INSTANCE.get("commonText.remove"), I18n.INSTANCE.get("commonText.removing"), false);
    public static Runnable runnableRemovePublisher = () -> OperationHelper.process(EditorManager.publisherEditor::removeMod, AnalyzeManager.publisherAnalyzer.getCustomContentString(), AnalyzeManager.publisherAnalyzer.getContentByAlphabet(), I18n.INSTANCE.get("commonText.publisher"), I18n.INSTANCE.get("commonText.removed"), I18n.INSTANCE.get("commonText.remove"), I18n.INSTANCE.get("commonText.removing"), false);
    public static Runnable runnableRemoveGameplayFeature = () -> OperationHelper.process(EditorManager.gameplayFeatureEditor::removeMod, AnalyzeManager.gameplayFeatureAnalyzer.getCustomContentString(), AnalyzeManager.gameplayFeatureAnalyzer.getContentByAlphabet(), I18n.INSTANCE.get("commonText.gameplayFeature"), I18n.INSTANCE.get("commonText.removed"), I18n.INSTANCE.get("commonText.remove"), I18n.INSTANCE.get("commonText.removing"), false);
    ...
    public static Runnable runnableRemoveLicence = () -> OperationHelper.process(EditorManager.licenceEditor::removeMod, AnalyzeManager.licenceAnalyzer.getCustomContentString(), AnalyzeManager.licenceAnalyzer.getContentByAlphabet(), I18n.INSTANCE.get("commonText.licence"), I18n.INSTANCE.get("commonText.removed"), I18n.INSTANCE.get("commonText.remove"), I18n.INSTANCE.get("commonText.removing"), false);
