...
public class TranslationManagerNew {
     ...
     */
    public TranslationManagerNew(Map<String, ?> map) {
     ...
     */
    public TranslationManagerNew(Map<String, String> nameTranslations, Map<String, String> descriptionTranslations) {
     ...
     * This is an alternative to using {@link TranslationManagerNew#printTranslations(BufferedWriter)}
