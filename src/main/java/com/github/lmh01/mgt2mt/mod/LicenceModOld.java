...
public class LicenceModOld extends AbstractSimpleModOld {
    private static final Logger LOGGER = LoggerFactory.getLogger(LicenceModOld.class);
    ...
    public AbstractSimpleModOld getSimpleMod() {
        return ModManager.licenceModOld;
    }
