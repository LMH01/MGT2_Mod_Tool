...
public class NpcGamesModOld extends AbstractSimpleModOld {
    private static final Logger LOGGER = LoggerFactory.getLogger(NpcGamesModOld.class);
    ...
    public AbstractSimpleModOld getSimpleMod() {
        return ModManager.npcGamesModOld;
    }
