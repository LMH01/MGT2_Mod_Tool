...
public abstract class AbstractSimpleModOld extends AbstractBaseModOld implements BaseFunctions, BaseMod, SimpleMod{
    private static final Logger LOGGER = LoggerFactory.getLogger(AbstractSimpleModOld.class);
     ...
     */
    public abstract AbstractSimpleModOld getSimpleMod();
}
